 ...
 */
return array(
	'title'      => __( 'Footer with logo and citation', 'arnulfotheme' ),
	...
	'content'    => '<!-- wp:group {"align":"full","layout":{"inherit":true}} -->
					...
					sprintf(
						...
						esc_html__( 'Proudly powered by %s', 'arnulfotheme' ),
						'<a href="' . esc_url( __( 'https://wordpress.org', 'arnulfotheme' ) ) . '" rel="nofollow">WordPress</a>'
					) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group --></div>
					<!-- /wp:group -->',
